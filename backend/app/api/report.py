...
def get_console_log(report_id: str):
    ...
    Retrieve console output (INFO, WARNING, etc.) from the report generation
    process in real-time. Unlike the agent-log endpoint which returns structured
    JSON logs, this returns plain-text console-style logs.
