...
def create_simulation():
    ...
    Note: Parameters such as max_rounds are intelligently generated by the LLM; no manual setup is needed
...
def _check_simulation_prepared(simulation_id: str) -> tuple:
    ...
    # Required files list (excludes scripts, which are located in backend/scripts/)
    required_files = [
        "state.json",
    ...
    try:
        ...
        # - completed: Run finished, meaning preparation was completed earlier
            ...
            if is_prepared:
                ...
                return jsonify({
                    ...
                    "data": {
                        ...
                        "status": "ready",
                        "message": "Preparation already completed, no regeneration needed",
...
def get_simulation_config(simulation_id: str):
    ...
    Returns:
        ...
        - agent_configs: Per-Agent activity settings (activity level, posting frequency, stance, etc.)
    ...
    Request (JSON):
        {
            ...
            "interviews": [                    // Required, interview list
                ...
                {
                    "agent_id": 1,
                    "prompt": "What is your opinion on B?"  // If platform not specified, uses default
                }
            ],
