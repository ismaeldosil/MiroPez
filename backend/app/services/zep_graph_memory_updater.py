...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        """
        Convert activity to a text description for sending to Zep
...
class ZepGraphMemoryUpdater:
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains full context information (e.g. post text, usernames).
                ...
                try:
                    ...
                    with self._buffer_lock:
                        ...
                        if len(self._platform_buffers[platform]) >= self.BATCH_SIZE:
                            ...
                            # Send interval to avoid overly frequent requests
    ...
    def _flush_remaining(self):
        ...
        # Then send remaining activities from each platform buffer (even if less than BATCH_SIZE)
        with self._buffer_lock:
