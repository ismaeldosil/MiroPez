...
class SimulationRunner:
    ...
    def register_cleanup(cls):
        ...
        Called at Flask application startup to ensure all simulation processes are cleaned up when server shuts down
        """
        ...
        # If not in debug mode, this env var doesn't exist, and cleanup should still be registered
    ...
    def close_simulation_env(
        ...
        try:
            ...
            # Timeout may be because environment is in the process of closing
            return {
                "success": True,
