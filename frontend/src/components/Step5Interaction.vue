        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Report Generation智能体的快速对话版本，with specialized tools，with full MiroFish memory</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulation environment state for cross-spatiotemporal deep attribution analysis via Global/Local Memory</div>
                  </div>
                </div>
                ...
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface, optimized for efficient extraction of node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interview agent that conducts parallel multi-turn dialogues with simulated individuals, collecting unstructured viewpoints and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent for deeper report insights' : 'Chat with simulated individuals to learn their views' }}
              </p>
            </div>
            <div 
...
const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('请先Select a simulated individual')
  }
  ...
  if (res.success && res.data) {
    // 正确的数据路径: res.data.result.results 是一targets字典
...
const submitSurvey = async () => {
  ...
  addLog(`Send Survey给 ${selectedAgents.value.size} targets...`)
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`Loaded simulation profiles`)
    }
  } catch (err) {
...
// Lifecycle
onMounted(() => {
  addLog('Step5 Deep InteractionInitialization')
  loadReportData()
  loadProfiles()
