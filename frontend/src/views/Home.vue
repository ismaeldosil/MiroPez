    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a single paragraph, <span class=”highlight-bold”>MiroFish</span> can extract real-world seeds and auto-generate a parallel world with up to <span class=”highlight-orange”>millions of Agents</span>. Inject variables from a god's-eye view to find <span class=”highlight-code”>”local optima”</span> in complex group interactions within dynamic environments.
            </p>
            <p class=”slogan-text”>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto prediction parsing & dynamic temporal memory update</div>
                </div>
              </div>
              <div class="workflow-item">
